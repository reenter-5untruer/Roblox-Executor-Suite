...
- Supports multiple popular Roblox executors
- Easy-to-use universal loader interface
...
XCutors is a collection of Roblox executors and script loaders for Windows desktop.

### Is XCutors free to use?

Yes, XCutors is completely free and open-source.

### How do I update XCutors?

Simply download the latest release from GitHub and replace the old files.

### Which executors are included?

XCutors includes Volt, Synapse Z, Potassium, Wave, and a universal loader.

### Do I need any special skills to use it?

Basic knowledge of Lua scripting is recommended, but the interface is user-friendly.

### Is it safe to use?

XCutors is designed to be safe, but always use it responsibly and at your own risk.

### Can I contribute to the project?

Yes, contributions are welcome on GitHub. Please read the contributing guidelines.
